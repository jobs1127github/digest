public class Tomcat优化{
	...
	maxParameterCount="1000000"， maxHttpHeaderSize="8192" 能提高tomcat处理请求的能力，能解决如下问题：
			ckground cache eviction process was unable to free [10] percent of the cache for Context [/qayyCMS] - consider increasing the maximum size of the cach
			e. After eviction approximately [9,245] KB of data remained in the cache.
			08-Sep-2018 09:44:07.534 INFO [http-nio2-8088-exec-36] 6] org.apache.coyote.http11.Http11Processor.service Err Error parsing HTTP request header
			 Note: further occurrences of HTTP header parsing errors will be logged at DEBUG level.
			 java.lang.IllegalArgumegumentException: Invalid character found in method name. HTTP method names must be tokens

...
public class SendMsgBean implements Serializable {
	private static final long serialVersionUID = -67738931364742849L;
	 ...
	 */
	public static void sendWeChatMsg(String msgType, String touser, String toparty,
			String totag, String content, String mediaId, String title,
			String description, String url, String picurl, String safe) {
		String ACCESS_TOKEN = TokenUtil.getToken();// 获取accessToken
		String action = MessageFormat.format("WXUrl.Send_MSG_URL", ACCESS_TOKEN);
		//该地方需要时，要修改WXUrl.Send_MSG_URL
		// 拼接请求串
		TokenUtil.getToken();// 获取accessToken
		// 封装发送消息请求json

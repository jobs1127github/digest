...
function queryAllInformation(){
	...
	var title = $("#sousuozi").val();
	sendRequest("${path}/wechat/queryAllInformation.do", {"mark":mark,"information_type":information_type,"orderby":orderby,"beginnum":beginnum,"title":title},function(jsonData){
		var data = jsonData.list;
		$("#aiinfo").html('');
		var page="";
...
<body bgcolor="efeff4" style="position:relative;">
	...
	<div class="container">
	    ...
	    <div align="center">
			<input type="text" 
				placeholder="可关键字搜索" id="sousuozi" style="text-align:center;background:url(''); border-color:#ffaa33;border-radius:0px 0px 0px 0px;width:56%;height:45px;"/>
			<input type="text" value="搜 索" readonly="readonly" style="text-align:center;color:#fff; border-radius:0px 0px 0px 0px;border:0px;height:45px;width: 40%;background:#ffaa33;" onclick="queryAllInformation()">
		</div>
			<!--  
			...
			<div class="aisort">
				<p>智能排序:</p>
				<li id="ap1" class="p1" onclick="queryorder(1)">发文时间</li>
				<li id="ap2" class="p2" onclick="queryorder(2)">打赏金额</li>
				<li id="ap3" class="p3 aisorted2" onclick="queryorder(3)">浏览量</li>
			</div>
			<div class="aiinfo" id="aiinfo"></div>
		</div>
		<div class="footer">
			<p onclick="fristpage()">首页</p>
			<p onclick="perpage()"><< 上一页</p>
			<p id="pager"></p>

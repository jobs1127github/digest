...
@Entity
@Table(name = "wx_information_share_count")
public class InformationShareCountVo implements Serializable{

	private static final long serialVersionUID = 3506751247916385591L;
	...
	@Column(name = "share_count", length = 32)

    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: center">
               <img alt="拼命下载中，请稍等 " src="${pageContext.request.contextPath}/img/wait.gif">
            </div>
        </div>
    </div>
</div>
                       ...
                       <div class="widget-body">
                           <table class="table table-bordered">
                               ...
                               <tr>
                                   ...
                                   <td>
                                    <input type="text" style="width:94%;" id="terminal" name="terminal" class="input-small"/>
                                   </td>
                               </tr>
                               </tbody>
                           </table>
                        ...
                        <!-- END BASIC PORTLET-->
                          ...
                          <center>
                              ...
                              <button type="button" class="btn blue" onclick="query();">
...
<script type="text/javascript">
    ...
    function refresh() {
        window.location.href = "${pageContext.request.contextPath }/WEB-INF/jsp/plans_query.jsp";
    }

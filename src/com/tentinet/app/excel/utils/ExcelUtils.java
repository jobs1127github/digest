package com.tentinet.app.excel.utils;
...
public class ExcelUtils {
	...
	public static void dataToExcel(String filePath, String sheetName,String[] title, List<Object> dataSet) {
		System.out.println("数据生成excel文件开始");
		// 创建一个webbook
		...
		try {
			/**方式1
			 * 若暂时不知道dataSet里的数据，也就是说dataSet这个数据还没准备好，我就开始写这里的程序了，
			 * 这时可以通过反射来完成。
			 */
		...
		System.out.println("数据生成excel文件结束");

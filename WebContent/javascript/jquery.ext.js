...
$.validator.addMethod("attr_identification_no", function(value) {
	if(value.length==0) {return true;}
	var p = /^\d{6}(18|19|20)?\d{2}(0[1-9]|1[12])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)$/i;
	return p.exec(value) ? true : false;
}, "请输入正确格式的身份证号");
...
$.extend($.validator.messages, {
	...
	path : "只能输入字符和数字的组合",
	attr_identification_no:"请输入正确格式的身份证号"
});
